...
func newTestLDB() (*energidb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ethdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := energidb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(energidb.NewMemDatabase(), t)
}

func testPutGet(db energidb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(energidb.NewMemDatabase(), t)
}

func testParallelPutGet(db energidb.Database, t *testing.T) {
	const n = 8
