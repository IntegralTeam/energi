...
// information related to the Energi protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(energi.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as energi.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria energi.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(energi.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
