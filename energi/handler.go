...
import (
	...
	"github.com/IntegralTeam/energi/energi/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkID uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb energidb.Database) (*ProtocolManager, error) {
...
func (pm *ProtocolManager) removePeer(id string) {
	...
	// Unregister the peer from the downloader and Energi peer set
...
// handle is the callback invoked to manage the life cycle of an energi peer. When
