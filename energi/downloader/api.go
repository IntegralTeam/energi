...
// Syncing provides information when this nodes starts synchronising with the Energi network and when it's finished.
...
type SyncingResult struct {
	...
	Status  energi.SyncProgress `json:"status"`
}
