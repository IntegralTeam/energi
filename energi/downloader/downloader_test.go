...
type downloadTester struct {
	...
	stateDb energidb.Database // Database used by the tester for syncing from peers
	peerDb  energidb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = energidb.NewMemDatabase()
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, energihash.NewFaker(), dl.peerDb, n, func(i int, block *core.BlockGen) {
