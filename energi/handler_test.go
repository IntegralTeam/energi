...
func testGetNodeData(t *testing.T, protocol int) {
	...
	statedb := energidb.NewMemDatabase()
...
// Tests that post energi protocol handshake, DAO fork-enabled clients also execute
...
func testDAOChallenge(t *testing.T, localForked, remoteForked bool, timeout bool) {
	...
	if !timeout {
		blocks, _ := core.GenerateChain(&params.ChainConfig{}, genesis, energihash.NewFaker(), db, 1, func(i int, block *core.BlockGen) {
			if remoteForked {
...
func testBroadcastBlock(t *testing.T, totalPeers, broadcastExpected int) {
	...
	chain, _ := core.GenerateChain(gspec.Config, genesis, energihash.NewFaker(), db, 1, func(i int, gen *core.BlockGen) {})
