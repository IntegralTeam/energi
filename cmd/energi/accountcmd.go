...
var (
	walletCommand = cli.Command{
		...
		Description: `
    energi wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	energi wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    energi account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    energi account import [options] <keyfile>
