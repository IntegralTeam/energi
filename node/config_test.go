...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "energi.ipc", false, filepath.Join(os.TempDir(), "energi.ipc")},
		{"data", "energi.ipc", false, "data/energi.ipc"},
		{"data", "./energi.ipc", false, "./energi.ipc"},
		{"data", "/energi.ipc", false, "/energi.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "energi.ipc", true, `\\.\pipe\energi.ipc`},
		{"data", "energi.ipc", true, `\\.\pipe\energi.ipc`},
		{"data", `\\.\pipe\energi.ipc`, true, `\\.\pipe\energi.ipc`},
	}
