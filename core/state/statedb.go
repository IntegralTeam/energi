...
//
// Carrying over the balance ensures that Energi doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/IntegralTeam/energi/pull/16485#issuecomment-380438527),
