...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(energidb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db energidb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db energidb.Database, root common.Hash) error {
...
func checkStateConsistency(db energidb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, energidb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(energidb.Database), srcRoot)
